<!---
Name:			compileClosureCompilerIndex.cfm
...
<cfoutput>
	...
	<cfscript>
		/* save the user-info in the application scope */
		application[application.appId] = ideeventinfo;
	
		/* Select the interface to load */
		baseURL = "http://" & cgi.server_name & ":" & cgi.server_port;
		messagesPath = getDirectoryFromPath(cgi.script_name) & "/compileClosureCompilerView.cfm";
	...
	<response showresponse="true"> 
		<ide url="#messagesURL#" > 
			<dialog width="100%" height="600" image="Logo.png" /> 
		</ide> 
	</response>
</cfoutput>